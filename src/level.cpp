...
{
    this->bricks_file_path = bricks_file_path;
    this->platform_movement_speed = platform_movement_speed;
    this->ball_movement_speed = ball_movement_speed;

    if (load(renderer, screen_width, screen_height))
...
bool Level::load(SDL_Renderer *renderer, int screen_width, int screen_height)
{
